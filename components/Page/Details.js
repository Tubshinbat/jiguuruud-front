...
const PageDetails = ({ data }) => {
  ...
  const renderPageInfo = (page) => {
    let title = "";
    if (page[cookies.language] && page[cookies.language].pageInfo) {
      title = page[cookies.language].pageInfo;
    } else if (cookies.language === "mn" && page["eng"]) {
      title = page["eng"].pageInfo;
    } else if (cookies.language === "eng" && page["mn"]) {
      title = page["mn"].pageInfo;
    }
    return title;
  };
  return (
